...
\def\myRefereeB{Dr. Marco Premoli}
...
\input{capitoli/02-modellazione-del-sistema.tex}
\input{capitoli/03-modelli-di-ottimizzazione.tex}
\input{capitoli/04-algoritmi-euristici.tex}
\input{capitoli/05-analisi-sperimentale.tex}
...
\begin{appendices}
    \input{appendici/01-modelli-di-ottimizzazione-frammentazione.tex}
\end{appendices}
